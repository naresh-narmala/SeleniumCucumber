...
public class ChromeBrowser {
	...
	public WebDriver getChromeDriver(Capabilities cap) {
		String file = Test.class.getResource("/driver/chromedriver").getFile();
		String newFile=file.replaceAll("target/test-classes","src/main/resources");
		System.setProperty("webdriver.chrome.driver", newFile);
